...
1.
Crear proceso. [pidiendo datos a usuario]
2.
Listar procesos. [mostrando todos los datos]
3.
Cerrar proceso. [mostrando solo nombres]
0. Salir.
–
...
public class Prog14 {
    //Iniciamos valores absolutos para el programa
        ...
        //Creamos objeto para guardar las variables
        Proceso p = new Proceso(nombre, comando);
        
            try{
                Process p2 = rt.exec(p.getComando());
                p.setPid(p2.pid());
                procesos.add(p);
            }catch(IOException e){
                e.printStackTrace();
